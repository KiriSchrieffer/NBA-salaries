...
def salary_avg_points(data_a: pd.DataFrame, data_b: pd.DataFrame) -> None:
    '''
    :param data_a: DataFrame, including player's basic information
    except salary
    :param data_b: DataFrame, including player's salary from 1985 to 2018
    Take two DataFrame as parameters and generate a html format file
    for graphing
    the relationship between NBA player's salary and points get per game.
    '''
    player_info = ['_id', 'career_PTS', 'height',
                   'weight', 'name', 'career_FG3%']
