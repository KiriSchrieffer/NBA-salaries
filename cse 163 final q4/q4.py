...
#This function accepts a list of assists, points per game and 3-point field goal of players,
#use salary cap to train the model
#print the R-squared value
#return a list of predict salary
def predict_salary_usecap(points: list) -> list:
    players = pd.read_csv('players.csv')
    salary = pd.read_csv('D:\qingy\Documents\cse 163 final\salaries_1985to2018 .csv')
    ...
    print("R-squared value for this prediction is " + str(r2_score(y_test, y_pred)))
