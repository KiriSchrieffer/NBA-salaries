...
# It will use the test files got by get_test_points_2023.py
# and get_test_salary_2023.py.
...
# merge data
data = test_salary_2023.merge(test_points_2023,
...
print("The percentage of relative error less than 50% is " + str(
    len(r_error[r_error <= 50]) / len(r_error) * 100) + "%.")
