...
merged_filtered = merged.query('career_FG3 >= @career_FG3_range[0] and\
                               career_FG3 <= @career_FG3_range[1]')
...
fig.update_layout(title='Height vs Career_FG3 (excluding outliers)',
                  showlegend=False)
